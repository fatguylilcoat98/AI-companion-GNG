...
function classifyExecutionIntent(intent) {
  ...
  switch (intent.type) {
    ...
    case INTENT_TYPES.GOVERNANCE_EXECUTION_AUTHORIZE:
      return _createDecision({
        intentType: intent.type,
        decision: DECISION_OUTCOMES.ADMISSIBLE,
    ...
    case INTENT_TYPES.GOVERNANCE_EXECUTION_CLAIM:
      return _createDecision({
        intentType: intent.type,
        decision: DECISION_OUTCOMES.ADMISSIBLE,
    ...
    case INTENT_TYPES.GOVERNANCE_EXECUTION_ATTEMPT:
      return _createDecision({
        intentType: intent.type,
        decision: DECISION_OUTCOMES.ADMISSIBLE,
    ...
    case INTENT_TYPES.GOVERNANCE_EXECUTION_OUTCOME_RECORD:
      return _createDecision({
        intentType: intent.type,
        decision: DECISION_OUTCOMES.ADMISSIBLE,
